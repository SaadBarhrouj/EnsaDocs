...
<body>
    ...
    <div style="font-family: Arial, sans-serif; color: #333;">
        ...
        <div style="padding: 20px; background-color: #f8f9fc; border-radius: 0 0 10px 10px;">
            <p style="font-size: 16px; line-height: 1.6;">Cher(e) <?php echo e($nom); ?>,</p>

            <p style="font-size: 16px; line-height: 1.6;">
                Nous avons examiné votre demande concernant <strong><?php echo e($type); ?></strong> et avons le plaisir de vous informer que <strong>votre demande a été validée</strong>.
            </p>
            ...
            <div style="background-color: #ffffff; padding: 15px; border: 1px solid #d1d3e2; border-radius: 5px;">
                ...
                <p><strong>Nom de l'étudiant :</strong> <?php echo e($nom); ?></p>
                <p><strong>Sujet de la demande :</strong> <?php echo e($type); ?></p>
                <p><strong>Réponse :</strong> Demande validée</p>
            </div>
            ...
            <div style="margin-top: 30px;">
                ...
                <p style="font-size: 16px; line-height: 1.6;">Nous vous remercions pour votre patience et votre compréhension.</p>
            </div>
        ...
        <div style="text-align: center; margin-top: 30px; font-size: 14px; color: #6c757d;">
            <p>Ce message a été envoyé par <strong><?php echo e(config('app.name')); ?></strong>.</p>
            <p>Si vous n'avez pas effectué cette demande, veuillez ignorer cet e-mail.</p>
        </div>
    </div>
</body>
</html>
<?php /**PATH /home/youssef-ghannam/Downloads/EnsaDocs-demande/resources/views/mail/valide.blade.php ENDPATH**/ ?>