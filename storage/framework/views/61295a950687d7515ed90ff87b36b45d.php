                    ...
                    <ul class="menu">
                        ...
                        <li class="sidebar-item has-sub">
                            ...
                            <ul class="submenu">
                                ...
                                <li class="submenu-item">
                                    <a href="admin/dashboard/Demandes_En_Cours" class="submenu-link">Demandes en cours</a>
                                </li>
                            </ul>
                        </li>
                        <!-- Réclamations -->
                        <li class="sidebar-item has-sub">
                            ...
                            <ul class="submenu">
                                <li class="submenu-item">
                                    <a href="Historiques_Demande" class="submenu-link">Historique de réclamations</a>
                                </li>
                                <li class="submenu-item">
...
</html><?php /**PATH C:\Users\PC\Desktop\ensadocs\mail\EnsaDocs\resources\views/dashboard.blade.php ENDPATH**/ ?>