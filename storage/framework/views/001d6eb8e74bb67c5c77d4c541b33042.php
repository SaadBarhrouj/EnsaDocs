    ...
    <div style="font-family: Arial, sans-serif; color: #333;">
        ...
        <div style="padding: 20px; background-color: #f8f9fc; border-radius: 0 0 10px 10px;">
            ...
            <p style="font-size: 16px; line-height: 1.6;">
                Nous avons examiné votre demande concernant <strong><?php echo e($type); ?></strong> et nous regrettons de vous informer que <strong>votre demande a été refusée</strong>.
            </p>
...
<?php /**PATH /home/youssef-ghannam/Downloads/EnsaDocs-demande/resources/views/mail/refuse.blade.php ENDPATH**/ ?>