...
<body>
    ...
    <main>
        ...
        <div class="content">
            ...
            <p>Numéro de la carte d'identité nationale : <strong>{{ $etudiant->cin ?? 'Not provided'}}</strong></p>
            <p>Code national de l'étudiante : <strong>{{ $etudiant->cne ?? 'Not provided'}}</strong></p>
            <p>Née le: <strong>{{ $etudiant->date_naissance ?? 'Not specified' }}</strong> à <strong>{{ $etudiant->lieu_naissance ?? 'Not specified' }} </p>
            ...
            <div class="details">
                ...
                <p>Filière : <strong>{{ $etudiant->filiere ?? 'Not specified' }}</strong></p>
            </div>
        </div>
    </main>
    ...
    <div class="footer">
            <p>Generated by EnsaDocs System</p>
        </div>
</body>
</html>
