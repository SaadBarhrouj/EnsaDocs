  ...
  font-size: 16px; 
        ...
        <div class="col-lg-5 col-md-4">
          <div class="header-login-register">
            <ul class="login">
              <li>
                <a><i class="fa fa-key"></i>Connexion Administrateur</a>
            ...
            <div class="col-lg-6">
              <div class="text-content hidden-xs">
                ...
                <div class="banner-readmore">
                  <a title="Read more" href="{{ url('demande') }}">Demander maintenant</a>
                </div>
              </div>
            </div>
          </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        ...
        <a href="{{ url('reclamation') }}">Soumettre la réclamation</a>
      </div>
    </div>
  </div>
</div>
